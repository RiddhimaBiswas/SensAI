  ...
  return (
    <>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 rounded-lg bg-transparent backdrop-blur-sm">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto px-4">
            ...
            <Link href="/dashboard" passHref>
              <Button
                size="lg"
                variant="secondary"
                className="h-11 mt-5 animate-bounce bg-zinc-100 text-zinc-900 hover:bg-zinc-200"
              >
                Start Your Journey Today <ArrowRight className="ml-2 h-4 w-4 font-bold" />
              </Button>
            </Link>
          </div>
        </div>
